        ...
        <>
            <nav>
                ...
                <ul>
                    ...
                    <li><Link to="https://oscarosorio-dev.vercel.app/cv.pdf" target='_blanck' onClick={() => window.scrollTo(0, 0)}>CV</Link></li>
                </ul>
            ...
            <div className={menuOpen ? "mobile-nav open-menu" : "mobile-nav closed-menu"}>
                <div class="close">
                    ...
                    <ul className='font-semibold'>
                        ...
                        <li>
                            <Link to="https://oscarosorio-dev.vercel.app/cv.pdf" onClick={() => menu()}>CV</Link>
                        </li>
                    </ul>
                </div>
            </div>
